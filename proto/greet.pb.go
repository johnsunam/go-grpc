...
var file_proto_greet_proto_rawDesc = string([]byte{
	...
	0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x40, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48,
...
var file_proto_greet_proto_goTypes = []any{
	...
	(*HelloResponse)(nil), // 3: greet_service.HelloResponse
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	2, // 2: greet_service.GreenService.SayHelloClientStreaming:input_type -> greet_service.HelloRequest
	2, // 3: greet_service.GreenService.SayHelloBidirectionalStreaming:input_type -> greet_service.HelloRequest
	3, // 4: greet_service.GreenService.SayHello:output_type -> greet_service.HelloResponse
	3, // 5: greet_service.GreenService.SayHelloServerStreaming:output_type -> greet_service.HelloResponse
	4, // 6: greet_service.GreenService.SayHelloClientStreaming:output_type -> greet_service.MessageList
	3, // 7: greet_service.GreenService.SayHelloBidirectionalStreaming:output_type -> greet_service.HelloResponse
